...
## The transformations:
> Test and training data sets are joined to create a single combined data set with 
> descriptive labels,activity names and subject IDs(ACTIVITY_ID,ACTIVITY_NAME,SUBJECT_ID).
> After that, only the measurements on the mean and standard deviation are extracted.

This script consists of the five parts(procedures).
